                                ...
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-success"><i
                                                    class="las la-trending-up"></i>8.5%</span> New Sessions
                                            Today</p>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-success"><i
                                                    class="las la-trending-up"></i>1.5%</span> Weekly
                                            Avg.Sessions</p>
                                    </div>
                                    <div class="col-auto align-self-center">
                                ...
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-danger"><i
                                                    class="las la-trending-down"></i>35%</span> Bounce Rate
                                            Weekly</p>
                                    </div>
                                    <div class="col-auto align-self-center">
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <p class="mb-0 text-truncate text-muted"><span class="text-success"><i
                                                    class="las la-trending-up"></i>10.5%</span> Completions
                                            Weekly</p>
                                    </div>
                                    <div class="col-auto align-self-center">
                    ...
                    <div class="card-body px-0">
                        <ul class="list-group list-group-flush mb-n3">
                            <li class="list-group-item align-items-center d-flex justify-content-between pt-0">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/logos/lang-logo/chatgpt.png" height="30"
                            ...
                            <li class="list-group-item align-items-center d-flex justify-content-between">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/logos/lang-logo/gitlab.png" height="30"
                                            class="me-2 align-self-center rounded" alt="...">
                                    </div>
                                    <div class="flex-grow-1 ms-2 text-truncate">
                            ...
                            <li class="list-group-item align-items-center d-flex justify-content-between">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/logos/lang-logo/meta.png" height="30"
                                            class="me-2 align-self-center rounded" alt="...">
                                    </div>
                                    <div class="flex-grow-1 ms-2 text-truncate">
                            ...
                            <li class="list-group-item align-items-center d-flex justify-content-between">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/logos/lang-logo/slack.png" height="30"
                                            class="me-2 align-self-center rounded" alt="...">
                                    </div>
                                    <div class="flex-grow-1 ms-2 text-truncate">
                            ...
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> -17.20% <i class="fas fa-caret-down text-danger font-16"></i>
                                        </td>
                    ...
                    <div class="card-body">
                        <div class="table-responsive browser_users">
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img src="assets/images/logos/chrome.png" alt="" height="16"
                                    ...
                                    <tr>
                                        <td><img src="assets/images/logos/micro-edge.png" alt="" height="16"
                                    ...
                                    <tr>
                                        <td><img src="assets/images/logos/in-explorer.png" alt="" height="16"
                                    ...
                                    <tr>
                                        <td><img src="assets/images/logos/opera.png" alt="" height="16"
                                                class="me-2">Opera</td>
                                        <td>1958<small class="text-muted">(31%)</small></td>
                                        <td> 36.82%</td>
                                        <td>361<small class="text-muted">(61%)</small></td>
